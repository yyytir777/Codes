...
print(len(user_padded_list[0]))
with open("input_data_500.pkl", "wb") as fr:
    pickle.dump(user_padded_list, fr)


with open("input_data_500.json", "w") as fr:
    json.dump(user_padded_list, fr)